...
class TableMappingEx extends TableMapping
{
    ...
    public function __construct(Connection $connection)
    {
        ...
        $tablesOrig = include __DIR__ . '/../../../../../Bundle/AttributeBundle/DependencyInjection/Resources/table_entity_mapping.php';
        $tablesAdd = include __DIR__ . '/table_entity_mapping_ex.php';
        $this->tables = array_merge($tablesOrig,$tablesAdd);
    }
